...
|---|---|---|---|---|---|---|---|
| Claim 1 (Tree guidance) | `evoresearcher_n3` | `evoresearcher_blind_n3` | — | — | — | 12.43 | PENDING (missing run) |
| Claim 2 (Elo ranking) | `evoresearcher_n3` | `evoresearcher_noelo_n3` | — | — | — | 12.43 | PENDING (missing run) |
| Claim 4 (EMA gain) | `evoresearcher_n3` | `evoresearcher_warm_n3` | — | — | — | 12.43 | PENDING (missing run) |
