...
\item Lebedev, V., Ganin, Y., Rakhuba, M., Oseledets, I., \& Lempitsky, V. (2015). Speeding-up Convolutional Neural Networks Using Fine-tuned CP-Decomposition. ICLR.
\item Liu, Z., Wang, Y., Vaidya, S., Ruehle, F., Halverson, J., Soljačić, M., Hou, T. Y., \& Tegmark, M. (2024). KAN: Kolmogorov-Arnold Networks. arXiv:2404.19756.
\item Kolda, T. G., \& Bader, B. W. (2009). Tensor Decompositions and Applications. SIAM Review.
\end{enumerate}
\end{document}
